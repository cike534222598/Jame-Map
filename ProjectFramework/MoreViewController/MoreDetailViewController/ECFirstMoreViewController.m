...
@interface ECFirstMoreViewController ()

@end

@implementation ECFirstMoreViewController

#pragma mark - 加载视图
- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    [self creatNavigationBarWithImage:nil title:@"主界面功能介绍"];
...
- (void)initWebView
{
    NSURL *url = [NSURL URLWithString:@"http://group.testing.amap.com/jing.chu/userhelpV7/function1.html"];
