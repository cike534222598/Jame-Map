...
@interface ECThirdMoreViewController ()

@end

@implementation ECThirdMoreViewController
...
- (void)viewDidLoad {
    ...
    [self creatNavigationBarWithImage:nil title:@"路线查询功能介绍"];
...
- (void)initWebView
{
    NSURL *url = [NSURL URLWithString:@"http://group.testing.amap.com/jing.chu/userhelpV7/function4.html"];
