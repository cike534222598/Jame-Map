...
@interface ECFourthMoreViewController ()

@end

@implementation ECFourthMoreViewController

#pragma mark - 加载视图
- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    [self creatNavigationBarWithImage:nil title:@"路线导航功能介绍"];
...
- (void)initWebView
{
    NSURL *url = [NSURL URLWithString:@"http://group.testing.amap.com/jing.chu/userhelpV7/function5.html"];
